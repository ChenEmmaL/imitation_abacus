...
parser.add_argument("-i", "--input_operation", help="The calculation to do, e.g 5+10+25-5-5", default="367+11") #default="5+10+25-5-5")
...
for i, el in enumerate(gif_list):
    el.save('simulations/prova'+str(i)+'.png')
    

#gif_list[0].save('simulations/qprova0_4.gif', append_images=gif_list[1:5], save_all=True, duration = len(gif_list)*10)
#gif_list[5].save('simulations/qprova5_11.gif', append_images=gif_list[6:12], save_all=True, duration = len(gif_list)*10)
#gif_list[11].save('simulations/qprova11_19.gif', append_images=gif_list[12:19], save_all=True, duration = len(gif_list)*10)
#gif_list[19].save('simulations/qprova19_25.gif', append_images=gif_list[20:25], save_all=True, duration = len(gif_list)*10)
